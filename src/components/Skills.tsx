...
// You could break these into categories/badges later if you want
const skills = [
    ...
    <div className="max-w-3xl mx-auto text-center px-6 relative z-10">
      ...
      <ul className="flex flex-col gap-4 text-lg md:text-xl text-[#b5eaff] font-mono font-semibold items-center">
        {skills.map((skill, idx) => (
          <li
            key={idx}
            className="bg-[#0c102ae6] border border-[#1ecbf6] rounded-xl px-6 py-3 shadow-md hover:shadow-neon transition"
            style={{
              minWidth: "250px",
              maxWidth: "90%",
              margin: "0 auto",
